  ...
  <div class="breadcrumb-area" style="background: url(<?php echo e($gs->breadcumb_banner ? asset('assets/images/'.$gs->breadcumb_banner):asset('assets/images/noimage.png')); ?>);">
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <h1 class="pagetitle">
            <?php echo e(__('Featured Auctions')); ?>
          ...
          <ul class="pages">
              ...
              <li>
                <a href="<?php echo e(route('front.featured')); ?>">
                  <?php echo e(__('Featured Auctions')); ?>
