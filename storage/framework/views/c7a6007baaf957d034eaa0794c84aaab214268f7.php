          ...
          <div class="col-lg-5">
            <div class="login-area">
              ...
              <div class="login-form">
                ...
                <form id="passwordform" action="<?php echo e(route('admin.change.password')); ?>" method="POST">
                  <?php echo e(csrf_field()); ?>


                  <div class="form-input">
                    <input type="password" name="newpass" class="Password" placeholder="<?php echo e(__('New Password')); ?>" required=""><i class="icofont-ui-password"></i>
                  </div>

                  <div class="form-input">
                    <input type="password" name="renewpass" class="Password" placeholder="<?php echo e(__('Re-Type New Password')); ?>" required=""><i class="icofont-ui-password"></i>
                  </div>
                  
                  <input type="hidden" name="admin_id" value="<?php echo e($id); ?>">
                  <input type="hidden" name="file_token" value="<?php echo e($token); ?>">

                  <button class="submit-btn"><?php echo e(__('Submit')); ?></button>
                </form>
              </div>
            </div>
          </div>
...
</html><?php /**PATH F:\xampp\htdocs\new_file\AuctionPro-Files\project\resources\views/admin/changepass.blade.php ENDPATH**/ ?>